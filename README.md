...
Minimalist osu! skin assets focusing on osu gameplay.
...
[scripts/render.py](scripts/render.py) is provided for step 1. The following
executables are required to run the script.

- rsvg-convert: render SVG
- magick: create a 1x1 transparent PNG

[scripts/gen_skinini.py](scripts/gen_skinini.py) is provided for step 2.
